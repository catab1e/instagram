        ...
        <div className='side-bar'>
            ...
            <div className='side-bar__panel'>
                <div className='panel__item'>
                    <span><HomeIcon className="panel-icons" width="32px" height="32px" /></span>
                    <p className='item__txt'>Home</p>
                </div>

                <div className='panel__item'>
                    <span><SearchIcon className="panel-icons" width="32px" height="32px" /></span>
                ...
                <div className='panel__item'>
                    <span><BellIcon className="panel-icons" width="32px" height="32px" /></span>
            ...
            <div className='panel__more'>
                <span><BurgerIcon className="panel-icons" width="32px" height="32px" /></span>
